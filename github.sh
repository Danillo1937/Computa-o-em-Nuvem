...
export name='Danillo1937'
export email="danillorodrigu3s@gmail.com"
export repositorio="https://github.com/Danillo1937/Computa-o-em-Nuvem.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="Versão 3"
